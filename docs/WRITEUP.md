...
Source: `reports/latest.json` / `reports/latest.md` from
`python -m scripts.run_eval` on this revision.
`generated_at_utc`: **2026-09-12T00:18:43.378079+00:00** (this eval run;
IID digits match the Week 2 checkpoints on the same weights).
