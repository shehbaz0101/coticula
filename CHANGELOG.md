...
Factual record of what shipped on `main` through v0.1.0 (Weeks 1–4).
Numeric tables are **not** copied here — they live in
[`docs/WRITEUP.md`](docs/WRITEUP.md) and [`reports/latest.md`](reports/latest.md)
and were generated by `python -m scripts.run_eval`. This file does not invent
metrics.

The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
The package version in `pyproject.toml` is already `0.1.0`.
